...
angular.module('folianApp')
  .controller('AccessoriesCtrl', ['$scope', '$location', '$rootScope', '$state', 'Acessories', 'NgTableParams',
    function ($scope, $location, $rootScope, $state, Acessories, NgTableParams) {
      var self = this;
